<template>
  <section
    id="footer"
    class="bg-white text-[#000000] py-16 min-h-screen flex items-center px-9 ml-20 sm:px-6 lg:px-16"
  >
    <!-- Footer Start -->
      ...
      <div class="container">
        <div class="flex flex-wrap">
          <div class="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
            <h2 class="font-bold text-4xl text-white mb-5">Awan Ardy</h2>
            <h2 class="font-bold text-2xl mb-2">Hubungi Kami</h2>
            <p>muhammadawan46@gmail.com</p>
        ...
        <div class="w-full pt-10 border-t border-slate-700">
          <div class="flex items-center justify-center mb-5">
            <!-- Github -->
            <a
              href="https://github.com/AwanArdy"
              target="_blank"
            ...
            <!-- Facebook -->
            <a
              href="https://web.facebook.com/Kinton.chan/"
              target="_blank"
              class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
            >
              <svg
            ...
            <!-- Instagram -->
            <a
              href="https://www.instagram.com/akari.kaeru/"
              target="_blank"
              class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
            >
              <svg
          ...
          <p class="font-medium text-sm text-slate-500 text-center">
            Dibuat dengan <span class="nogizaka">努力! 感謝! 笑顔!</span>
          </p>
        </div>
      </div>
    </footer>
